...
var Designer = function Designer(_ref) {
  ...
  var LazyVisualizer = (0, _Visualizer.useLazyVisualizer)([globalState, widgets, ready]);
  ...
  return /*#__PURE__*/_react["default"].createElement(_MuiPickersUtilsProvider["default"], {
    ...
    action:
    /*#__PURE__*/
    // TODO: Widget Event Handle Tip Action
    _react["default"].createElement(_Button["default"], {
      variant: "text",
      size: "small",
      onClick: function onClick(_ref7) {
        var currentTarget = _ref7.currentTarget;
        var pathname = currentTarget.closest('[data-pathname]').dataset.pathname;
  ...
  }), actions)), /*#__PURE__*/_react["default"].createElement(_react["default"].Suspense, {
    fallback: null
  }, /*#__PURE__*/_react["default"].createElement(LazyVisualizer, {
    uid: ROOT_ID,
    ready: ready
    ...
    onElementDispatch: function onElementDispatch(e) {
      return dispatch((Array.isArray(e) ? e : [e]).map(function (_ref10) {
        var type = _ref10.type,
            param = _objectWithoutProperties(_ref10, _excluded);
    ...
    onStateBinding: function onStateBinding(_ref11, checked) {
      var target = _ref11.uid,
          value = _ref11.path,
